...
class CustomResetPassword extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->line('Para reestablecer su contraseña haga click en el siguiente enlace:')
            ->action('Restablecer contraseña', $url);
        // ->line('Este enlace de restablecimiento de contraseña expirará en 60 minutos.', ['count' => config('auth.passwords.' . config('auth.defaults.passwords') . '.expire')])
